...
export default {
  ...
  effects: {
    *fetch({ payload }, { call, put }) {
      ...
      const result = yield call(queryRole, payload);
    ...
    *submitForm({ payload, callback }, { call, put }) {
      const response = !payload.id ? yield call(addRole, payload) : yield call(updateRole, payload);
      if (response) {
        callback(response);
      }
    },
    *fetchMenuResources({ payload, callback }, { call, put }) {
      const response = yield call(getRoleMenuResources, payload);
      if (response) {
        callback(response);
      }
    },
    *assignMenuResource({ payload, callback }, { call, put }) {
      const response = yield call(assignMenuResource, payload);
      if (response) {
        callback(response);
      }
    },
